...
EOT;
    ...
    <div id="main">
     ...
     echo "<form action='order_check.php' method='post'>";
        ...
        while ($row = mysqli_fetch_array($result)) {
         echo"<input type='checkbox' id='sauce' name='sauce' value='" . $row['id_sauce'] ."'>" . $row['type_name'] ."<br>";
        }
        echo "</div>";
        //EXTRAS KIIRATAS
        echo "<div id='order_checkbox'>";
        ...
        while ($row = mysqli_fetch_array($result)) {
            echo"<input type='checkbox' id='extras' name='extras' value='" . $row['id_extras'] ."'>" . $row['type_name'] ."<br>";
        }
        echo "</div>";
        echo <<<EOT
